...
ActiveRecord::Schema.define(version: 20151116180619) do

  # These are extensions that must be enabled in order to support this database
  enable_extension "plpgsql"

  create_table "account_list_entries", force: :cascade do |t|
  ...
  create_table "account_list_invites", force: :cascade do |t|
    t.integer  "account_list_id"
  ...
  create_table "account_list_users", force: :cascade do |t|
    t.integer  "user_id"
    t.integer  "account_list_id"
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  create_table "appeal_contacts", force: :cascade do |t|
    t.integer  "appeal_id"
    t.integer  "contact_id"
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  create_table "contact_donor_accounts", force: :cascade do |t|
    t.integer  "contact_id"
  ...
  create_table "contacts", force: :cascade do |t|
    ...
    t.date     "next_ask"
    t.string   "likely_to_give",          limit: 255
    t.string   "church_name",             limit: 255
    t.string   "send_newsletter",         limit: 255
    ...
    t.string   "prayer_letters_id",       limit: 255
    t.string   "timezone",                limit: 255
    t.string   "envelope_greeting",       limit: 255
    t.boolean  "no_appeals"
    t.text     "prayer_letters_params"
    t.string   "pls_id",                  limit: 255
    t.text     "pls_params"
  end
  ...
  create_table "designation_accounts", force: :cascade do |t|
    ...
    t.string   "name",               limit: 255
    t.string   "staff_account_id",   limit: 255
    t.string   "chartfield",         limit: 255
  ...
  create_table "designation_profile_accounts", force: :cascade do |t|
  ...
  create_table "designation_profiles", force: :cascade do |t|
    t.string   "remote_id",          limit: 255
  ...
  create_table "donations", force: :cascade do |t|
    ...
    t.string   "tendered_currency",      limit: 255
  ...
  create_table "donor_account_people", force: :cascade do |t|
    t.integer  "donor_account_id"
    t.integer  "person_id"
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  create_table "donor_accounts", force: :cascade do |t|
    t.integer  "organization_id"
  ...
  create_table "google_contacts", force: :cascade do |t|
    ...
    t.datetime "created_at"
    t.datetime "updated_at"
    t.string   "picture_etag",      limit: 255
  ...
  create_table "google_email_activities", force: :cascade do |t|
  ...
  create_table "google_emails", force: :cascade do |t|
    t.integer  "google_account_id"
  ...
  create_table "google_integrations", force: :cascade do |t|
    ...
    t.string   "calendar_id",           limit: 255
    t.string   "calendar_name",         limit: 255
  ...
  create_table "mail_chimp_accounts", force: :cascade do |t|
    t.string   "api_key",            limit: 255
    t.boolean  "active",                         default: false
    t.integer  "grouping_id"
    t.string   "primary_list_id",    limit: 255
    t.integer  "account_list_id"
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  create_table "mail_chimp_appeal_lists", force: :cascade do |t|
    t.integer  "mail_chimp_account_id",             null: false
    t.string   "appeal_list_id",        limit: 255, null: false
  ...
  create_table "mail_chimp_members", force: :cascade do |t|
    t.integer  "mail_chimp_account_id",             null: false
    t.string   "list_id",               limit: 255, null: false
    t.string   "email",                 limit: 255, null: false
    t.string   "status",                limit: 255
    t.string   "greeting",              limit: 255
  ...
  create_table "master_addresses", force: :cascade do |t|
    t.text     "street"
    t.string   "city",            limit: 255
    t.string   "state",           limit: 255
    t.string   "country",         limit: 255
  ...
  create_table "master_people", force: :cascade do |t|
    t.datetime "created_at"
    t.datetime "updated_at"
  end

  create_table "master_person_donor_accounts", force: :cascade do |t|
  ...
  create_table "master_person_sources", force: :cascade do |t|
    t.integer  "master_person_id"
    t.integer  "organization_id"
    t.string   "remote_id",        limit: 255
    t.datetime "created_at"
  ...
  create_table "name_male_ratios", force: :cascade do |t|
  ...
  create_table "organizations", force: :cascade do |t|
    t.string   "name",                          limit: 255
    t.string   "query_ini_url",                 limit: 255
    t.string   "iso3166",                       limit: 255
    t.string   "minimum_gift_date",             limit: 255
    t.string   "logo",                          limit: 255
    t.string   "code",                          limit: 255
    t.boolean  "query_authentication"
    t.string   "account_help_url",              limit: 255
    t.string   "abbreviation",                  limit: 255
    t.string   "org_help_email",                limit: 255
    t.string   "org_help_url",                  limit: 255
    t.string   "org_help_url_description",      limit: 255
    t.text     "org_help_other"
    t.string   "request_profile_url",           limit: 255
    t.string   "staff_portal_url",              limit: 255
    t.string   "default_currency_code",         limit: 255
    t.boolean  "allow_passive_auth"
    t.string   "account_balance_url",           limit: 255
    t.string   "account_balance_params",        limit: 255
    t.string   "donations_url",                 limit: 255
    t.string   "donations_params",              limit: 255
    t.string   "addresses_url",                 limit: 255
    t.string   "addresses_params",              limit: 255
    t.string   "addresses_by_personids_url",    limit: 255
    t.string   "addresses_by_personids_params", limit: 255
    t.string   "profiles_url",                  limit: 255
    t.string   "profiles_params",               limit: 255
    t.string   "redirect_query_ini",            limit: 255
    t.datetime "created_at"
    t.datetime "updated_at"
    t.string   "api_class",                     limit: 255
  end
  ...
  create_table "person_facebook_accounts", force: :cascade do |t|
    t.integer  "person_id",                                    null: false
  ...
  create_table "person_google_accounts", force: :cascade do |t|
    t.string   "remote_id",       limit: 255
    t.integer  "person_id"
    t.string   "token",           limit: 255
  ...
  create_table "person_key_accounts", force: :cascade do |t|
    t.integer  "person_id"
    t.string   "remote_id",     limit: 255
    t.string   "first_name",    limit: 255
    t.string   "last_name",     limit: 255
  ...
  create_table "person_linkedin_accounts", force: :cascade do |t|
    t.integer  "person_id",                                    null: false
  ...
  create_table "person_organization_accounts", force: :cascade do |t|
    t.integer  "person_id"
    t.integer  "organization_id"
    t.string   "username",          limit: 255
  ...
  create_table "person_relay_accounts", force: :cascade do |t|
    t.integer  "person_id"
    t.string   "remote_id",     limit: 255
    t.string   "first_name",    limit: 255
    t.string   "last_name",     limit: 255
  ...
  create_table "person_twitter_accounts", force: :cascade do |t|
    t.integer  "person_id",                                 null: false
  ...
  create_table "person_websites", force: :cascade do |t|
    t.integer  "person_id"
  ...
  create_table "pictures", force: :cascade do |t|
    ...
    t.string   "picture_of_type", limit: 255
  ...
  create_table "pls_accounts", force: :cascade do |t|
    t.integer  "account_list_id"
  ...
  create_table "prayer_letters_accounts", force: :cascade do |t|
    t.string   "token",           limit: 255
    t.string   "secret",          limit: 255
    t.boolean  "valid_token",                 default: true
    t.datetime "created_at"
  ...
  create_table "recurring_recommendation_results", force: :cascade do |t|
    t.integer  "account_list_id"
    t.integer  "contact_id"
  ...
  create_table "versions", force: :cascade do |t|
    ...
    t.text     "object"
    t.string   "related_object_type", limit: 255
