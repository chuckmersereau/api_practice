...
describe PhoneNumberExhibit do
  ...
  it 'should return an extension when included in the local number' do
    phone_number.number = '2135555555;ext=1234'
    expect(subject.number).to eq('(213) 555-5555 ext 1234')
  end

  it 'should return an e164 formatted number when an intl number is provided' do
    phone_number.country_code = ''
    phone_number.number = '613-555-55555'
    expect(subject.number).to eq('+61355555555')
  end

  it 'should return an e164 formatted number and ext when included with an intl number' do
    phone_number.country_code = ''
