...
describe NotificationType::LongTimeFrameGift do
  ...
  context 'Parner gives a donation in-time' do
    let!(:donation) { create(:donation, donor_account: donor_account, designation_account: da, donation_date: Date.today) }
  ...
  context 'Partner gives a donation early' do
    let!(:donation) { create(:donation, donor_account: donor_account, designation_account: da, donation_date: Date.today << 2) }
