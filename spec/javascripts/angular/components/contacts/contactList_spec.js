describe('contacts', function() {
    ...
    describe('handleContactQueryChanges', function(){
        ...
        it('should call clearSelectedContacts if the filter changed', function(){
    ...
    xdescribe('loadViewPreferences', function(){
        beforeEach(function(){
            //Flush contact load http request
            self.$httpBackend.expectGET(/\/api\/v1\/contacts.*/).respond(200, {
                meta: {total: 122, from: 1, to: 25, page: 1, total_pages: 5}
            });
    ...
    it('contact api should return 1 contact', function() {
        ...
        self.$httpBackend.when("PUT", "/api/v1/users/me").respond({}, {});
