class Api::V2::Contacts::People::FacebookAccountsController < Api::V2Controller
  def index
    ...
    load_fb_accounts
    render json: @fb_accounts, meta: meta_hash(@fb_accounts), include: include_params, fields: field_params
  end
  ...
  def load_fb_account
    @fb_account ||= fb_account_scope.find_by_uuid_or_raise!(params[:id])
  end
