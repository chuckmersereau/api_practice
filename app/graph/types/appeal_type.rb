module Types
  AppealType = GraphQL::ObjectType.define do
    ...
    field :currencies, types[types.String], 'The currencies of the donations for this Appeal' do
      resolve -> (obj, arg, ctx) {
        obj.donations.currencies
      }
    end
    ...
    field :totalCurrency, types.String, "The type of currency for the Appeal's donations to be converted to" do
      resolve -> (obj, arg, ctx) {
        obj.account_list.salary_currency_or_default
      }
    end
